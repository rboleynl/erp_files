...
public class PathFormat {
	...
	//maolujun
	private static final String ERPPATH = "erp_path";
	...
	//maolujun
	public static String parse ( String input, String filename, Map<String, Object> conf ) {
		...
		while ( matcher.find() ) {
			...
			if ( matchStr.indexOf( "filename" ) != -1 ) {
				...
				matcher.appendReplacement(sb, PathFormat.getString( matchStr, conf ) );
			}
	...
	//maolujun
	private static String getString ( String pattern, Map<String,Object> conf ) {
		...
		if ( pattern.indexOf( PathFormat.TIME ) != -1 ) {
			...
			return PathFormat.getRandom( pattern );
		} else if ( pattern.indexOf( PathFormat.ERPPATH ) != -1 ) {//maolujun
			final Object erpPath = conf.get(PathFormat.ERPPATH);
			if(null != erpPath && erpPath instanceof String){
				return (String) erpPath;
			}
			return "";
		}
